...
#define _OLED_H
  ...
  #define  OLED_DC_L   GPIO_ResetBits(GPIOA, GPIO_Pin_11)  //拉低DC，选择命令
  #define  OLED_DC_H   GPIO_SetBits(GPIOA, GPIO_Pin_11)    //拉高DC，选择数据
  //CLK  时钟线
  #define  OLED_CLK_L   GPIO_ResetBits(GPIOB, GPIO_Pin_13)  //拉低CLK
  #define  OLED_CLK_H   GPIO_SetBits(GPIOB, GPIO_Pin_13)    //拉高CLK 
  //RES  硬复位OLED
  #define  OLED_RES_L   GPIO_ResetBits(GPIOA, GPIO_Pin_12)  //拉低RES
  #define  OLED_RES_H   GPIO_SetBits(GPIOA, GPIO_Pin_12)    //拉高RES 
  //MOSI 主输出数据线
  #define  OLED_MOSI_L   GPIO_ResetBits(GPIOB, GPIO_Pin_15)  //拉低MOSI
  #define  OLED_MOSI_H   GPIO_SetBits(GPIOB, GPIO_Pin_15)    //拉高MOSI
	//DS   片选线
	#define  OLED_DS_L   GPIO_ResetBits(GPIOA, GPIO_Pin_15)  //拉低MOSI
  #define  OLED_DS_H   GPIO_SetBits(GPIOA, GPIO_Pin_15)    //拉高MOSI
