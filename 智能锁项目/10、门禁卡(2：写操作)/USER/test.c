...
int main(void)
{		
	u8 readDataBuf[16]={0x88,0x88,0x88,0x88,0x88,0x88,0x88,0x88,0x88,0x88,0x88,0x88,0x88,0x88,0x88,0x88};	
	...
	while(1)
	{
		delay_ms(1000);
		//注意：第0块是没法修改的
		if(WriteCardData(PICC_AUTHENT1A,10,KEY,readDataBuf,CardId)==MI_OK)
